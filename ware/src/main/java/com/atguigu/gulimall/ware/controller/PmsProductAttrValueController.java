...
import com.atguigu.gulimall.ware.service.PmsProductAttrValueService;
 ...
 */
@RestController
@RequestMapping("ware/pmsproductattrvalue")
public class PmsProductAttrValueController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsproductattrvalue:list")
   ...
   // @RequiresPermissions("ware:pmsproductattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsproductattrvalue:save")
    ...
    //@RequiresPermissions("ware:pmsproductattrvalue:update")
    ...
    //@RequiresPermissions("ware:pmsproductattrvalue:delete")
