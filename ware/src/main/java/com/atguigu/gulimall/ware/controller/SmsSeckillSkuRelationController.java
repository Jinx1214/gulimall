...
public class SmsSeckillSkuRelationController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsseckillskurelation:list")
   ...
   // @RequiresPermissions("ware:smsseckillskurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsseckillskurelation:save")
    ...
    //@RequiresPermissions("ware:smsseckillskurelation:update")
    ...
    //@RequiresPermissions("ware:smsseckillskurelation:delete")
