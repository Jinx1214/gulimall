...
import com.atguigu.gulimall.ware.entity.PmsAttrEntity;
import com.atguigu.gulimall.ware.service.PmsAttrService;
...
public class PmsAttrController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsattr:list")
   ...
   // @RequiresPermissions("ware:pmsattr:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsattr:save")
    ...
    //@RequiresPermissions("ware:pmsattr:update")
    ...
    //@RequiresPermissions("ware:pmsattr:delete")
