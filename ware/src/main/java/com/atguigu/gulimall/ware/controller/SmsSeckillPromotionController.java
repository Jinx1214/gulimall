...
public class SmsSeckillPromotionController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsseckillpromotion:list")
   ...
   // @RequiresPermissions("ware:smsseckillpromotion:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsseckillpromotion:save")
    ...
    //@RequiresPermissions("ware:smsseckillpromotion:update")
    ...
    //@RequiresPermissions("ware:smsseckillpromotion:delete")
