...
public class SmsSeckillSessionController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsseckillsession:list")
   ...
   // @RequiresPermissions("ware:smsseckillsession:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsseckillsession:save")
    ...
    //@RequiresPermissions("ware:smsseckillsession:update")
    ...
    //@RequiresPermissions("ware:smsseckillsession:delete")
