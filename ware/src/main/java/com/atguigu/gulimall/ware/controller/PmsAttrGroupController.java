...
import com.atguigu.gulimall.ware.service.PmsAttrGroupService;
 ...
 */
@RestController
@RequestMapping("ware/pmsattrgroup")
public class PmsAttrGroupController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsattrgroup:list")
   ...
   // @RequiresPermissions("ware:pmsattrgroup:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsattrgroup:save")
    ...
    //@RequiresPermissions("ware:pmsattrgroup:update")
    ...
    //@RequiresPermissions("ware:pmsattrgroup:delete")
