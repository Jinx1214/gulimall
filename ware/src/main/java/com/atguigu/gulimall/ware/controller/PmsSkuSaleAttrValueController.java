...
import com.atguigu.gulimall.ware.service.PmsSkuSaleAttrValueService;
 ...
 */
@RestController
@RequestMapping("ware/pmsskusaleattrvalue")
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsskusaleattrvalue:list")
   ...
   // @RequiresPermissions("ware:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("ware:pmsskusaleattrvalue:update")
    ...
    //@RequiresPermissions("ware:pmsskusaleattrvalue:delete")
