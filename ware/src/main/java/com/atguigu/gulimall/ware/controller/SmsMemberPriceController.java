...
public class SmsMemberPriceController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsmemberprice:list")
   ...
   // @RequiresPermissions("ware:smsmemberprice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsmemberprice:save")
    ...
    //@RequiresPermissions("ware:smsmemberprice:update")
    ...
    //@RequiresPermissions("ware:smsmemberprice:delete")
