 ...
 */
@RestController
@RequestMapping("ware/pmscategorybrandrelation")
public class PmsCategoryBrandRelationController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmscategorybrandrelation:list")
   ...
   // @RequiresPermissions("ware:pmscategorybrandrelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmscategorybrandrelation:save")
    ...
    //@RequiresPermissions("ware:pmscategorybrandrelation:update")
    ...
    //@RequiresPermissions("ware:pmscategorybrandrelation:delete")
