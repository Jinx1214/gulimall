...
public class SmsSkuLadderController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsskuladder:list")
   ...
   // @RequiresPermissions("ware:smsskuladder:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsskuladder:save")
    ...
    //@RequiresPermissions("ware:smsskuladder:update")
    ...
    //@RequiresPermissions("ware:smsskuladder:delete")
