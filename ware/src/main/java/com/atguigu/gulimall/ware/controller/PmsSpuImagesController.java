 ...
 */
@RestController
@RequestMapping("ware/pmsspuimages")
public class PmsSpuImagesController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsspuimages:list")
   ...
   // @RequiresPermissions("ware:pmsspuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsspuimages:save")
    ...
    //@RequiresPermissions("ware:pmsspuimages:update")
    ...
    //@RequiresPermissions("ware:pmsspuimages:delete")
