...
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsskufullreduction:list")
   ...
   // @RequiresPermissions("ware:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsskufullreduction:save")
    ...
    //@RequiresPermissions("ware:smsskufullreduction:update")
    ...
    //@RequiresPermissions("ware:smsskufullreduction:delete")
