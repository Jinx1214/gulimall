...
public class SmsSeckillSkuNoticeController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smsseckillskunotice:list")
   ...
   // @RequiresPermissions("ware:smsseckillskunotice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smsseckillskunotice:save")
    ...
    //@RequiresPermissions("ware:smsseckillskunotice:update")
    ...
    //@RequiresPermissions("ware:smsseckillskunotice:delete")
