 ...
 */
@RestController
@RequestMapping("ware/pmsspucomment")
public class PmsSpuCommentController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:pmsspucomment:list")
   ...
   // @RequiresPermissions("ware:pmsspucomment:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:pmsspucomment:save")
    ...
    //@RequiresPermissions("ware:pmsspucomment:update")
    ...
    //@RequiresPermissions("ware:pmsspucomment:delete")
