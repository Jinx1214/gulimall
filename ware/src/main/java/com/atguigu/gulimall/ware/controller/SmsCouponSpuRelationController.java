...
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("ware:smscouponspurelation:list")
   ...
   // @RequiresPermissions("ware:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:smscouponspurelation:save")
    ...
    //@RequiresPermissions("ware:smscouponspurelation:update")
    ...
    //@RequiresPermissions("ware:smscouponspurelation:delete")
